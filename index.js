...
/**
 * Función principal que agrega una nueva tarea a la lista.
...
function agregarTarea() {
  ...
  // Obtiene el texto del input y elimina espacios extra al inicio/fin.
  const taskText = taskInput.value.trim();

  // Si el input está vacío, no hace nada y sale de la función.
  if (taskText === "") return;
  ...
  span.textContent = taskText; // Asigna el texto.
